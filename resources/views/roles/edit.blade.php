                    ...
                    <div class="col-6">
                        ...
                        <form method="POST" action="{{ route('roles.update', $role->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" placeholder="Name" class="form-control" value="{{ $role->name ?? old('name') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" name="permission[]" value="{{ $value->id }}" class="form-check-input" {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }}>
